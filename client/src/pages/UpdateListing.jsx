...
const UpdateListing = () => {
    ...
    useEffect(() => {
        axios.get(`https://real-estate-website-1.onrender.com/properties/${id}`)
            .then((response) => {
                ...
                setFormLocation({
                    ...
                    aptSuite: response.data.aptSuite,
                ...
                setFormDescription({
                    ...
                    highlightDesc: response.data.highlightDesc,
